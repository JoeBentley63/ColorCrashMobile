...
{
    class ColorBurster : isBlock
    {

        public ColorBurster(Vector2 _pos, Color _colour)
        {
            this._pos = _pos;
            this._colour = _colour;
            _preloader = SpriteLoader.GetInstance();
            _texture = _preloader.Load("clearall");
        ...
        public override void Draw(SpriteBatch _spriteBatch)
        {
            ...
            if (_selected == false)
            {
                _spriteBatch.Draw(_texture, _pos, null, Color.White * _fallScale, _fallAngle, new Vector2(32, 32), _fallScale, SpriteEffects.None, .7f);
